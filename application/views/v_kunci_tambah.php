                    ...
                    <div class="row">
                        <form method="post" action="<?php echo base_url() ?>index.php/kunci/simpan_kunci" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="sifat" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="hari" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tanggal
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="date" name="tanggal1" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            <div class="form-group">
